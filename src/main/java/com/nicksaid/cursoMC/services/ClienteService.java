...
import com.nicksaid.cursoMC.security.UserSS;
...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteDTO objDto) {//Metodo auxiliar que instancia uma Cliente a partir de um DTO
	...
	public URI uplodProfilePecture(MultipartFile multipartFile) {
