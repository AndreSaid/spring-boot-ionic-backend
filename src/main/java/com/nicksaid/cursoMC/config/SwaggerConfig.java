...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.nicksaid.cursoMC.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				...
				"https://www.udemy.com/terms",
				 new Contact("Andre Said", "", "nicksaiddev@gmail.com"),
				"Linkedin",
				"https://www.linkedin.com/in/andre-said-8519bb65/",
